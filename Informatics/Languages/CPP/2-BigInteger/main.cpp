...
void test2() {
  assert(BigInteger("123456789123456789") == BigInteger("123456789123456789"));
...
void test7() {
  int a = 5;
  BigInteger b(77654345678), c(3), d(5);
  assert(a < b);
  assert(a > c);
  assert(a >= c);
  assert(a != c);
...
int main() {
  ...
  std::cerr
      << "BigInteger small tests passed. Now starting Rational tests...\n";
  testRational<Rational, BigInteger>();

  std::cerr << "Rational tests passed. Now starting performance tests...\n";
  performanceTest<BigInteger>();
